    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Trezarcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  trezarcoind [options]                     " + "\n" +
                  "  trezarcoind [options] <command> [params]  " + _("Send command to -server or trezarcoind") + "\n" +
                  "  trezarcoind [options] help                " + _("List commands") + "\n" +
                  "  trezarcoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "trezarcoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: trezarcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: trezarcoind.pid)") + "\n" +
