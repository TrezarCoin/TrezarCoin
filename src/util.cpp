...
const char * const BITCOIN_CONF_FILENAME = "trezarcoin.conf";
const char * const BITCOIN_PID_FILENAME = "trezarcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Trezarcoin";
#else
    fs::path pathRet;
